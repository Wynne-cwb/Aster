...
Plans:
- [x] 06-01-PLAN.md — Wave 0 测试桩（excel/ppt/word write test + ChatStream + OnboardingModal + system-prompt）
- [ ] 06-02-PLAN.md — ExcelAdapter 新方法（insertChart/deleteChartByName/applyFormula/setCell）
- [ ] 06-03-PLAN.md — PptAdapter 新方法（setShapeProperty/restoreShapeProperty/moveShape/restoreShapeGeometry/setShapeText/restoreShapeText）
