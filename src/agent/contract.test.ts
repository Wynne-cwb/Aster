...
const CONTRACT: ContractEntry[] = [
  ...
  { toolName: 'set_shape_text_alignment', host: 'ppt', undoType: '简单逆向', reverseTool: 'restore_shape_alignment', phase: 10, integrationTest: true },
  { toolName: 'add_shape', host: 'ppt', undoType: '简单逆向', reverseTool: 'delete_shape_by_id', phase: 10, integrationTest: true },
  { toolName: 'delete_shape', host: 'ppt', undoType: 'noop+gate', reverseTool: 'noop_inverse', phase: 10, integrationTest: true },
  { toolName: 'rotate_shape', host: 'ppt', undoType: '简单逆向', reverseTool: 'restore_shape_rotation', phase: 10, integrationTest: true },
